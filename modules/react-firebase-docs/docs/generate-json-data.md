---
sidebar_label: Generate JSON Data
...
- [Setup](#setup)
      ...
      - [CLI](#cli)
- [Usage](#usage)
    - [Generate data based on data shape.](#generate-data-based-on-data-shape)
    - [Generate data based on data shape and key reducers.](#generate-data-based-on-data-shape-and-key-reducers)
